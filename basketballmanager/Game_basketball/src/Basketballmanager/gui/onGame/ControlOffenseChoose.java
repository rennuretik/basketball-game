...
public class ControlOffenseChoose extends JPanel implements ActionListener{
	JButton ballhandling=new JButton("球权分配");
	JButton scorehandling=new JButton("出手权分配");
	JButton createOpportunity=new JButton("进攻发起分配");
	JButton strategy=new JButton("进攻战术分配");
