...
public class controlBarChoose extends JPanel implements ActionListener{
	public JButton TimeOutShort=new JButton("‘›Õ£(5)");
	public JButton Offense=new JButton("Ω¯π•≤ﬂ¬‘");
	public JButton Defense=new JButton("∑¿ ÿ≤ﬂ¬‘");
	public JButton Player=new JButton("«Ú‘±–≈œ¢");
	controlBarChoose()
	{
